...
export const WIDGET_TYPES: WidgetTypeDef[] = [
  ...
  { type: 'tasks', label: 'My tasks', hint: 'Open activities assigned to the viewer.', icon: <ListChecks className={ICON} />, needs: { module: true, columns: true }, defaultSize: { w: 4, h: 5 } },
  ...
  { type: 'calendar', label: 'Calendar', hint: 'Upcoming site visits and activities.', icon: <Calendar className={ICON} />, needs: {}, defaultSize: { w: 4, h: 5 } },
